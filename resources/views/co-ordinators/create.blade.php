...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">Add New Co-ordinator</div>
            <div class="card-body">
                <form id="engineerForm" method="POST" action="{{ route('co-ordinators.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="departments[]" id="departments" multiple></select>
                    ...
                    <button type="submit" class="btn btn-primary">Create Co-ordinator</button>
                    <a href="{{ route('co-ordinators.index') }}" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
