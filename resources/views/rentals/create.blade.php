...
@section('content')
    <div class="bg-light p-4 rounded">
        <div class="mt-4">
            <form method="POST" action="{{ route('rentals.store') }}" enctype="multipart/form-data" id="mainForm" autocomplete="off"> @csrf
                ...
                <div class="row">
                    <div class="col-8 nopadding-left">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="text" name="code" tabindex="-1" placeholder="Code" id="code" class="form-control text-uppercase" value="{{ old('code', $rentalNumber) }}">
                            @if ($errors->has('code'))
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="text" name="date" class="form-control" id="orderDate" value="{{ old('date', date('d-m-Y H:i')) }}">
                            @if ($errors->has('date'))
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <textarea id="fetch-location" class="form-control" name="custom_address" style="margin-top:10px;display:none;"></textarea>
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="text" name="po" id="po" class="form-control" placeholder="Purchase Order" value="{{ old('po') }}">
                        </div>
                        ...
                        <div class="mb-3 col-12 nopadding-left d-none">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="hidden" name="price_level_rate_id" id="price_level_rate_id">
                        ...
                        <div class="row">
                            <div class="mb-3 col-6 nopadding-left">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="isfreq" name="frequency_contract" role="switch" value="1" checked>
                            ...
                            <div class="mb-3 col-6 nopadding-right" id="container-for-perpetual">
                                <div class="form-check form-switch float-end">
                                    <input type="checkbox" name="perpatual" id="perpatual" value="1" class="form-check-input" role="switch">
                        ...
                        <div class="main-container-for-frequency border border-secondary pt-4" style="border-radius:15px;margin-bottom:10px;">
                            <div class="row mb-3 col-12 nopadding-left">

                                <div class="col-6">
                                    <label for="from" class="form-label"> <span id="start-date-from-label"> Start Date </span> <span class="text-danger"> * </span> </label>
                                    <input type="text" class="form-control" name="from" id="from" value="{{ old('from', date('d-m-Y 00:00')) }}">
                                ...
                                <div class="col-6 hidable-endate">
                                    <label for="to" class="form-label"> <span id="end-date-to-label"> End Date </span> <span class="text-danger"> * </span> </label>
                                    <input type="text" class="form-control" name="to" id="to" value="{{ old('from', date('d-m-Y 23:59', strtotime('+1 day'))) }}">
                            ...
                            <div class="row mb-3 col-12 nopadding-left" id="container-for-rental-service-date">
                                ...
                                <div class="col-6" id="container-for-new-rental">
                                    ...
                                    <input type="text" class="form-control" name="deliver" id="deliver" value="{{ old('deliver', date('d-m-Y H:i')) }}">
                                ...
                                <div class="col-6" id="container-for-first-removal">
                                    ...
                                    <input type="text" class="form-control" name="removal" id="removal" value="{{ old('removal', date('d-m-Y H:i')) }}">
                            ...
                            <div class="row mb-3 col-12 nopadding-left"  id="container-for-frequency">
    
                                <div class="col-6">
                                    <label class="form-label"> Frequency <span class="text-danger"> * </span> </label>
    
                                    <div class="show-only-days d-none">
                                        <input type="checkbox" id="monday" data-week="1" name="select_days[]" value="monday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="monday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Monday </label> <br>
        
                                        <input type="checkbox" id="tuesday" data-week="2" name="select_days[]" value="tuesday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="tuesday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Tuesday </label> <br>
        
                                        <input type="checkbox" id="wednesday" data-week="3" name="select_days[]" value="wednesday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="wednesday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Wednesday </label> <br>
        
                                        <input type="checkbox" id="thursday" data-week="4" name="select_days[]" value="thursday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="thursday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Thursday </label> <br>
        
                                        <input type="checkbox" id="friday" data-week="5" name="select_days[]" value="friday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="friday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Friday </label> <br>
        
                                        <input type="checkbox" id="saturday" data-week="6" name="select_days[]" value="saturday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="saturday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Saturday </label> <br>
        
                                        <input type="checkbox" id="sunday" data-week="0" name="select_days[]" value="sunday" style="height:15px;width:15px;margin-top:10px;">
                                        <label for="sunday" class="form-label" style="position:relative;bottom:1px;left:5px;"> Sunday </label>
                                    </div>
    
                                    <div class="show-only-frequency">
                                        <select name="frequency" id="frequency">
                                            <option value="1"> Daily </option>
                                        </select>
                                    </div>
    
                                    <input type="checkbox" value="1" name="frequency_type" id="check_days" style="height:15px;width:15px;margin-top:10px;">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="frequency_time" id="frequency_time" class="form-control" value="{{ date('H:i') }}">
                                </div>
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <textarea name="instruction" class="form-control">{{ old('instruction') }}</textarea>
                        </div>

                    </div>

                    <div class="col-4 nopadding-left nopadding-right">
                        <div class="mb-3 col-12 nopadding-left">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            <label for="cb" class="form-label"> Customer Charge Basis </label>
                            <input type="text" name="cb" placeholder="Customer Charge Basis" id="cb" value="daily" class="form-control text-uppercase" readonly>
                        </div>

                        <div class="mb-3 col-12 nopadding-left d-none">
                            <label for="cb" class="form-label"> Charge Basis Count <strong class="show-on-perp invisible"> &nbsp;&nbsp; (UPTO MONTH END  / PERPETUAL) </strong> </label>
                            <input type="text" id="cbcd" class="form-control text-uppercase" value="1 day" disabled>
                            <input type="hidden" name="cbc" id="cbc" />
                        </div>

                        <div class="mb-3 col-12 nopadding-left">
                            <label for="rental_rate" class="form-label"> Rental Rate <strong class="show-on-perp invisible"> &nbsp;&nbsp; (UPTO MONTH END  / PERPETUAL) </strong> <span class="text-danger"> * </span> </label>
                            <input type="number" step="0.01" min="0" name="rental_rate" placeholder="Rental Rate" id="rental_rate" class="form-control" value="{{ old('rental_rate') }}" readonly>
                        ...
                        <div class="mb-3 col-12 nopadding-left for-rental">
                            ...
                            <input type="number" step="0.01" min="0" placeholder="Total Rental" id="total_rental_rate" name="total_rental_rate" class="form-control" value="{{ old('rental_rate') }}" readonly>
                        </div>

                        <div class="mb-3 col-12 nopadding-left">
                            <label for="removal_rate" class="form-label"> Removal <span class="text-danger"> * </span> </label>
                            <input type="number" step="0.01" min="0" name="removal_rate" placeholder="Removal" id="removal_rate" class="form-control" value="{{ old('removal_rate') }}">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" step="0.01" min="0" name="driver" placeholder="Driver" id="driver" class="form-control" value="{{ old('driver') }}">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" step="0.01" min="0" name="second" placeholder="Second" id="second" class="form-control" value="{{ old('second') }}">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" step="0.01" min="0" name="tipping_fee" placeholder="Tipping Fee" id="tipping_fee" class="form-control" value="{{ old('tipping_fee') }}">
                        ...
                        <div class="mb-3 col-12 nopadding-left days-input-visibility">
                            <label for="days" class="form-label"> Days <span class="text-danger"> * </span> </label>
                            <input type="number" min="1" name="days" placeholder="Days" id="days" class="form-control" value="1" readonly>
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            <label for="rental_counter" class="form-label"> Total <span class="label-of-service-removal"> Removals </span> <span class="text-danger"> * </span> </label>
                            <input type="number" min="1" class="form-control" value="1" id="rental_counter" name="rental_counter" readonly>
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            <input type="checkbox" name="flat_rate_check" id="flat_rate_check" value="1" style="height: 20px;width:20px;" />
                            <label for="flat_rate_check" class="form-label" style="position: relative;bottom: 4px;left: 5px;"> Flat rate</label>
                        </div>

                        <div class="mb-3 col-12 nopadding-left">
                            <input type="checkbox" name="has_zero_total" id="has_zero_total" style="height: 20px;width: 20px;" value="1">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" min="0" step="0.01" name="total_rental" placeholder="Total Rental" id="total_rental" class="form-control" value="0" readonly>
                            <input type="hidden" name="old_total_rental" id="old_total_rental" class="form-control" value="0">
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" step="0.01" min="0" name="total_tax" placeholder="Total Tax" id="total_tax" class="form-control" value="0" readonly>
                        ...
                        <div class="mb-3 col-12 nopadding-left">
                            ...
                            <input type="number" step="0.01" min="0" name="total" placeholder="Total" id="total" class="form-control" value="0" readonly>
                            <div class="form-control" id="grand-zero-total"></div>
...
@push('js')
    ...
    <script>
        var dailyRentalRate = 0;
        var monthlyRentalRate = 0;
        var newRentalRate = 0;
