...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">Edit Engineer</div>
            <div class="card-body">
                <form id="engineerForm" method="POST" action="{{ route('engineers.update', encrypt($engineer->id)) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <a href="{{ route('engineers.index') }}" class="btn btn-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
