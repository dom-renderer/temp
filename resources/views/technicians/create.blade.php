...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form id="engineerForm" method="POST" action="{{ route('technicians.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exptertises" class="form-label">Expertise </label>
                        <select name="exptertises[]" id="exptertises" multiple></select>
                        @error('exptertises')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
