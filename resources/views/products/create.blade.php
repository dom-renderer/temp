            ...
            <div class="card-body">
                <form id="productForm" method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2" id="category_id" name="category_id" required></select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_1') is-invalid @enderror" id="description_1" name="description_1">{{ old('description_1') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_2') is-invalid @enderror" id="description_2" name="description_2">{{ old('description_2') }}</textarea>
