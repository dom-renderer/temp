...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form id="engineerForm" method="POST" action="{{ route('customers.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3 row">
                                <div class="col-12">
                                    ...
                                    <input type="tel" class="form-control @error('alternate_phone_number') is-invalid @enderror" id="phone_number" name="alternate_phone_number" value="{{ old('alternate_phone_number') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="address_line_1" id="address_line_1" class="form-control @error('address_line_1') is-invalid @enderror" required>{{ old('address_line_1') }}</textarea>
                                @error('address_line_1')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-3">
                                <label for="address_line_2" class="form-label">Address Line 2</label>
                                <textarea name="address_line_2" id="address_line_2" class="form-control @error('address_line_2') is-invalid @enderror">{{ old('address_line_2') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="location_url" id="location_url" value="{{ old('location_url') }}">
