...
class UserController extends Controller
{
    ...
    protected static $excludeRoles = ['dealer', 'interior'];
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data['can_add_invoice'] = $request->has('can_add_invoice');
            $data['can_approve_invoice'] = $request->has('can_approve_invoice');
            $data['can_publish_invoice'] = $request->has('can_publish_invoice');
